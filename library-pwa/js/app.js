class LibraryApp {
    ...
    getDefaultBooks() {
        return [
            // Trending Books
            {
                ...
                isbn: '978-0465050659',
                format: 'both',
                coverUrl: 'https://m.media-amazon.com/images/I/416Hql52NCL.jpg'
            },
            {
                id: 2,
                title: 'Atomic Habits',
            ...
            },
            {
                ...
                isbn: '978-0735219090',
                format: 'both',
                coverUrl: 'https://m.media-amazon.com/images/I/51j5p8YZ-0L._SY291_BO1,204,203,200_QL40_FMwebp_.jpg'
            },
            {
                id: 5,
                ...
                isbn: '978-1250301697',
                format: 'both',
                coverUrl: 'https://m.media-amazon.com/images/I/51OuP0mmnwL._SY291_BO1,204,203,200_QL40_FMwebp_.jpg'
            },
            ...
            // Kids Books
            {
                ...
                category: 'kids',
                availability: 'available',
                description: 'This is a book about a very hungry caterpillar growing up.',
                isbn: '978-0399226908',
                format: 'physical',
                coverUrl: 'https://m.media-amazon.com/images/I/41tyokViuNL._SY291_BO1,204,203,200_QL40_FMwebp_.jpg'
            },
            {
                id: 7,
                ...
                category: 'kids',
                availability: 'available',
                description: 'The story of Max\'s journey to where the wild things are.',
                isbn: '978-0064431781',
                format: 'physical',
                coverUrl: 'https://m.media-amazon.com/images/I/61AlB5pgRBL._SY291_BO1,204,203,200_QL40_FMwebp_.jpg'
            },
            {
                id: 8,
                ...
                category: 'kids',
                availability: 'available',
                description: 'A little bunny says goodnight to all the things in his room.',
                isbn: '978-0694003617',
                format: 'physical',
                coverUrl: 'https://m.media-amazon.com/images/I/51Ix49rxgtL._SX218_BO1,204,203,200_QL40_FMwebp_.jpg'
            },
            {
                id: 9,
                title: 'The Gruffalo',
                ...
                category: 'kids',
                availability: 'available',
                description: 'A mouse takes a walk in the forest and outwits all the animals he meets.',
                isbn: '978-0803731097',
                format: 'physical',
                coverUrl: 'https://m.media-amazon.com/images/I/61TtQpOhbWL._SY291_BO1,204,203,200_QL40_FMwebp_.jpg'
            },
            
            // Textbooks
            {
                id: 10,
                title: 'Database System: A Practical Approach to Design, Implementation, and Management',
                author: 'Thomas Connolly and Carolyn Begg',
                year: '2014',
                rating: 4.3,
                category: 'textbook',
                availability: 'available',
                description: 'A comprehensive introduction to the theory and practice of database systems.',
                isbn: '978-0132943260',
                format: 'both',
                coverUrl: 'https://m.media-amazon.com/images/I/51bnDXr4pML._SX218_BO1,204,203,200_QL40_FMwebp_.jpg'
            },
            {
                id: 11,
            ...
            },
            {
                ...
                isbn: '978-0134610993',
                format: 'both',
                coverUrl: 'https://m.media-amazon.com/images/I/51xwccJOtCL._SX218_BO1,204,203,200_QL40_FMwebp_.jpg'
            },
            {
                id: 13,
                ...
                category: 'textbook',
                availability: 'available',
                description: 'A comprehensive introduction to computer networks.',
                isbn: '978-0132126953',
                format: 'both',
                coverUrl: 'https://m.media-amazon.com/images/I/51vNpYXYGwL._SX218_BO1,204,203,200_QL40_FMwebp_.jpg'
            },
            {
                id: 14,
                ...
                category: 'textbook',
                availability: 'available',
                description: 'A comprehensive introduction to operating systems.',
                isbn: '978-1119456339',
                format: 'both',
                coverUrl: 'https://m.media-amazon.com/images/I/51Qy2upM+aL._SY344_BO1,204,203,200_.jpg'
            },
            ...
            // Fiction Books
            {
                ...
                isbn: '978-0446310789',
                format: 'both',
                coverUrl: 'https://m.media-amazon.com/images/I/51IXWZzlgSL._SY291_BO1,204,203,200_QL40_FMwebp_.jpg'
            },
            {
                id: 16,
                title: '1984',
                ...
                isbn: '978-0451524935',
                format: 'both',
                coverUrl: 'https://m.media-amazon.com/images/I/41aM4xOZxaL._SY291_BO1,204,203,200_QL40_FMwebp_.jpg'
            },
            {
                id: 17,
                ...
                category: 'fiction',
                availability: 'available',
                description: 'A novel of lyrical beauty and uncompromising vision, The Great Gatsby is the story of Jay Gatsby, a self-made millionaire, and his pursuit of Daisy Buchanan, a wealthy young woman whom he loved in his youth.',
                isbn: '978-0743273565',
                format: 'both',
                coverUrl: 'https://m.media-amazon.com/images/I/41XMaCHkrgL._SY291_BO1,204,203,200_QL40_FMwebp_.jpg'
            },
            {
                id: 18,
                ...
                isbn: '978-0141439518',
                format: 'both',
                coverUrl: 'https://m.media-amazon.com/images/I/41k29Fict8L._SY291_BO1,204,203,200_QL40_FMwebp_.jpg'
            },
            {
                id: 19,
                title: 'The Hobbit',
                ...
                isbn: '978-0547928227',
                format: 'both',
                coverUrl: 'https://m.media-amazon.com/images/I/51uLvJlKpNL._SY291_BO1,204,203,200_QL40_FMwebp_.jpg'
            },
            {
                id: 20,
                ...
                category: 'fiction',
                availability: 'available',
                description: 'The first novel in the Harry Potter series, featuring Harry Potter, a young wizard who discovers his magical heritage on his eleventh birthday.',
                isbn: '978-0590353427',
                format: 'both',
                coverUrl: 'https://m.media-amazon.com/images/I/51DF6ZR8G7L._SY291_BO1,204,203,200_QL40_FMwebp_.jpg'
            }
        ];
    }
    ...
    updateSidebar() {
        ...
        const commonItems = [
            ...
            { page: 'update-profile', icon: '👤', text: 'Update Profile' },
            { page: 'logout', icon: '🚪', text: 'Log out' }
        ];
        ...
        if (this.currentUser.role === 'student') {
            roleItems = [
                { page: 'search-books', icon: '🔍', text: 'Search Books' },
                { page: 'return-book', icon: '📙', text: 'Return Book' },
                { page: 'reserve-room', icon: '🏢', text: 'Reserve Room' }
            ];
        } else if (this.currentUser.role === 'librarian') {
            roleItems = [
                { page: 'total-books', icon: '📚', text: 'Total Books' },
                { page: 'borrow-requests', icon: '📝', text: 'Borrow Requests' },
                { page: 'members', icon: '👥', text: 'Members' }
            ];
        } else if (this.currentUser.role === 'admin') {
            roleItems = [
                { page: 'total-books', icon: '📚', text: 'Total Books' },
                { page: 'members', icon: '👥', text: 'Members' },
                { page: 'settings', icon: '⚙️', text: 'Settings' }
            ];
        }
        ...
        if (this.currentUser.role === 'student') {
            ...
            setTimeout(() => {
                ...
                if (chartCanvas && typeof Chart !== 'undefined') {
                    ...
                    if (chartContainer) {
                        chartContainer.innerHTML = 'Chart.js not loaded. Please include Chart.js library.';
                    }
                }
            }, 100);
        }
    ...
    populateBooks() {
        const categories = ['trending', 'kids', 'textbook', 'fiction'];
    ...
    showBookDetail(bookId) {
        ...
        if (borrowButton) {
            ...
            const alreadyRequested = this.borrowRequests.some(r => r.bookId == book.id && r.userId == this.currentUser.id && r.status === 'pending');
    ...
    handleAddBook() {
        ...
        const coverUrl = document.getElementById('book-cover-url').value || 'https://via.placeholder.com/150x200?text=No+Cover';
    ...
    generateCalendar() {
        ...
        setTimeout(() => {
            ...
            for (let day = 1; day <= daysInMonth; day++) {
                ...
                const hasReservation = this.roomReservations.some(res => 
                    res.userId === this.currentUser.id && 
                    new Date(res.date).toLocaleDateString() === dateString
                );
                
                // Check book due dates
                const hasDueBook = this.borrowedBooks.some(book => 
                    book.userId === this.currentUser.id && 
                    new Date(book.dueDate).toLocaleDateString() === dateString
                );
